...
Movies.count()
#Info of the Movies dataset includes indication if there are null values and the Pandas data type
Movies.info()
...
Ratings.count()
#Info of the Ratings dataset includes indication if there are null values and the Pandas data type
Ratings.info()
# HEAD() displays the first five rows, first five index values
Ratings.head()
# TAIL() To display the bottom 5 rows
...
#Used to count the number of rows in Ratings
Users.count()
#Info of the Users dataset includes indication if there are null values and the Pandas data type
Users.info()
# head() displays the first five rows, first five index values, of every column within a Pandas data frame object.
Users.head()
# tail() To display the bottom 5 rows
Users.tail()
...
wordcloud = WordCloud(width=550,height=300, background_color='white', 
                      max_words=1628,relative_scaling=0.7, normalize_plurals=False)
...
MasterDataset['Age'].value_counts().plot(kind='bar', color = 'purple',figsize = (8,7))
plt.xlabel("Age")
